...
def lines_are_parallel(list_1, list_2):
    if list_1[0] / list_2[0] == list_1[1] / list_2[1]:
        #return ('%dx+%dy=%d and %dx+%dy=%d are paralell'%(list_1[0], list_1[1], list_1[2], list_2[0], list_2[1], list_2[2]))
        return True
    elif  list_1[0] / list_2[0] == list_1[1] / list_2[1] == list_1[2] / list_2[2]:
        #return  'Lines are parallel to themselves'
        return True
    else:
        #return (' %dx+ %dy=%d  and  %dx+%dy=%d are not paralell'%(list_1[0], list_1[1], list_1[2], list_2[0], list_2[1], list_2[2]))
        return False
